<div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav">
        ...
        <li><a href="index.php?reports"><i class="fa fa-fw fa-bar-chart-o"></i> Reports</a></li>
        <li>
            <a href="index.php?orders"><i class="fa fa-fw fa-bar-chart-o"></i> Orders</a>
        </li>

        <li>
            <a href="index.php?view_product"><i class="fa fa-fw fa-bar-chart-o"></i> View Products</a>
        </li>
        <li>
        ...
        <li>
            <a href="index.php?gallery"><i class="fa fa-fw fa-wrench"></i>Gallery</a>
        </li>
